...
public class CustomerService extends javax.swing.JFrame {
     ...
     * @param user
     */
    public CustomerService(Intermediary inter) {
        initComponents();
        this.inter =inter;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(150, 50, 126, 16);

        jLabel2.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 24)); // NOI18N
        jLabel2.setText("ROYAL STAR HOTEL ");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(120, 10, 179, 26);
    ...
    private void orderFoodBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_orderFoodBtnActionPerformed
        ...
        OrderFood orderFood = new OrderFood (inter);
    ...
    private void bookRoomBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookRoomBtnActionPerformed
        // TODO add your handling code here:
        BookRoom bookRoom = new BookRoom (inter);
        this.setVisible(false);
